...
var landscapeKeyboardHeight = CGFloat(192)/// ** why manually determined?  These values (keyboard heights for different iOS devices) seem nowhere to be found online
