...
func formattedDateString(_ date: Date, roundDown: Bool, showYear: Bool, prefix: String?, suffix: String, dateFormat: CustomDateFormat) -> String { // * probably will clean this method up at some point
    ...
    case .hourAndMinuteNewlined:    return " \(hr):\(minTwoDigits)\n \(ampm)"
